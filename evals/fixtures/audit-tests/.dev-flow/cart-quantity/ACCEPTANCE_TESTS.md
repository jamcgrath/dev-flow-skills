...
- AC2 a quantity-0 line contributes nothing → `subtotal of an empty cart is zero`
...
- `subtotal of an empty cart is zero` (test/acceptance.test.js) — `subtotal([])` returns 0.
